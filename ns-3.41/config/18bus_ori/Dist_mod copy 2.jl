                ...
                while iter <= 5
                        ...
                        while length(received_ids) < num_RPi
                                ...
                                try                        
                                        ...
                                        data, sender = udpsock.recvfrom(1024)
                                        after_time1 = time()
                                        ...
                                        if isa(e, PyError)
                                                println("Python error: ", pystr(e.val))
                                            if e.T == timeout_exception
                                                println("Timeout: No data received within the timeout period.")
                                                break  # Exit the loop if a timeout happens
                                            else
