...
NS_LOG_COMPONENT_DEFINE("MyAppApplication");
    ...
    static TypeId tid =
        TypeId("ns3::MyApp")
            ...
            .AddAttribute("Port",
                          ...
                          UintegerValue(9),
                          MakeUintegerAccessor(&MyApp::m_port),
            ...
            .AddTraceSource("RxWithAddresses",
                            "A packet has been received",
                            MakeTraceSourceAccessor(&MyApp::m_rxTraceWithAddresses),
...
MyApp::StartApplication()
{
    ...
    m_socket6->SetRecvCallback(MakeCallback(&MyApp::HandleRead, this));
}
