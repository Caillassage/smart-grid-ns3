...
println("full_path: ", "./../../$name")

JSON_File = JSON.parsefile("./../../$name")

rho = JSON_File["rho"]
iter = JSON_File["round"]
MAX_ITER = 200

x1 = JSON_File["x1"]["vect"]
x2 = JSON_File["x2"]["vect"]
x3 = JSON_File["x3"]["vect"]

t1 = JSON_File["x1"]["t_val"]
t2 = JSON_File["x2"]["t_val"]
t3 = JSON_File["x3"]["t_val"]

obj1 = JSON_File["x1"]["obj_val"]
obj2 = JSON_File["x2"]["obj_val"]
obj3 = JSON_File["x3"]["obj_val"]

z12 = JSON_File["z12"]
z13 = JSON_File["z13"]

lambda_121 = JSON_File["lambda_121"]
lambda_122 = JSON_File["lambda_122"]
lambda_131 = JSON_File["lambda_131"]
lambda_133 = JSON_File["lambda_133"]
...
if iter <= MAX_ITER
    ...
    println("x2: ", length(x2))
    println("x3: ", length(x3))
    println("z12: ", length(z12))
    println("z13: ", length(z13))
    println("lambda_121: ", length(lambda_121))
    println("lambda_122: ", length(lambda_122))
    println("lambda_131: ", length(lambda_131))
    println("lambda_133: ", length(lambda_133))
