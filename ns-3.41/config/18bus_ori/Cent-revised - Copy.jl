using JuMP,  XLSX, Plots, DataFrames, CSV, JLD2, Ipopt
...
#= Extended bus set - not needed for graphing values found using centralized optimization method
BUS_SET_ex = Dict()
BUS_SET_ex["area_1"] = sort(unique(union(BUS_SET["area_1"],[4])))
BUS_SET_ex["area_2"] = sort(unique(union(BUS_SET["area_2"],[3])))

OBRANCH_SET = Dict() - not needed for graphing values found using centralized optimization method
OBRANCH_SET["area_1"] = [(3,4)]
OBRANCH_SET["area_2"] = [(3,4)]


# Extended branch set - not needed for graphing values found using centralized optimization method
BRANCH_SET_ex = Dict()
...
TBUS_SET["area_2"] = union(TBUS_SET["area_2"],4) - not needed for graphing values found using centralized optimization method
=#


BRANCH_PHS_SET = Dict()
BRANCH_PHS_SET["area_0"] = make_branch_phs_set(EXCELSHEET)
#BRANCH_PHS_SET["area_1"] = BRANCH_PHS_SET["area_0"] - not needed for graphing values found using centralized optimization method
#BRANCH_PHS_SET["area_2"] = BRANCH_PHS_SET["area_0"] - not needed for graphing values found using centralized optimization method

BUS_PHS_SET = Dict()
BUS_PHS_SET["area_0"] = make_bus_phs_set(EXCELSHEET)
#BUS_PHS_SET["area_1"] = BUS_PHS_SET["area_0"] - not needed for graphing values found using centralized optimization method
#BUS_PHS_SET["area_2"] = BUS_PHS_SET["area_0"] - not needed for graphing values found using centralized optimization method

INBRANCH_SET["area_0"], OUTBRANCH_SET["area_0"] = make_bounding_branch_set(SUPER_SET)
#INBRANCH_SET["area_1"] = INBRANCH_SET["area_0"] - not needed for graphing values found using centralized optimization method
#INBRANCH_SET["area_2"] = INBRANCH_SET["area_0"] - not needed for graphing values found using centralized optimization method
#OUTBRANCH_SET["area_1"] = OUTBRANCH_SET["area_0"] - not needed for graphing values found using centralized optimization method
#OUTBRANCH_SET["area_2"] = OUTBRANCH_SET["area_0"] - not needed for graphing values found using centralized optimization method
